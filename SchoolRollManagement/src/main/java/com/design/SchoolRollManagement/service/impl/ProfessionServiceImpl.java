...
import com.design.SchoolRollManagement.mapper.ProfessionMapper;
...
public class ProfessionServiceImpl implements ProfessionService {
     ...
     */
    @Override
    public RestFulBean<Map> getList(Page<Profession> page) throws Exception{
    ...
    public RestFulBean<String> insert(Profession profession) {
        this.professionMapper.insert(profession);//执行数据库的新增语句
    ...
    @Override
     public RestFulBean<String> update(Profession profession) {
        this.professionMapper.update(profession);//执行数据库的修改语句 根据id 修改
    ...
    public RestFulBean<String> deleteById(Integer id) {
        this.professionMapper.deleteById(id);//执行数据库的删除语句 根据id 删除
         return RestFulBean.succ("删除成功");
    }

    @Override
    public RestFulBean<List<Profession>> getProfessionList() {
        List<Profession> list =professionMapper.getProfessionList();
